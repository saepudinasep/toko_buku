      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            ...
            <li <?php if($menu=="data_pegawai" || $menu=="tambah_pegawai" || $menu=="edit_pegawai" || $menu=="hapus_pegawai"){echo "class='active'";} ?>><a href="?menu=data_pegawai">Data Pegawai</a></li>
            <li <?php if($menu=="data_buku" || $menu=="tambah_buku" || $menu=="edit_buku" || $menu=="hapus_buku"){echo "class='active'";} ?>><a href="?menu=data_buku">Data Buku</a></li>
            <li <?php if($menu=="data_distributor" || $menu=="tambah_distributor" || $menu=="edit_distributor" || $menu=="hapus_distributor"){echo "class='active'";} ?>><a href="?menu=data_distributor">Data Distributor</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <?php
            ...
            switch($_GET['menu']){
              ...
              case 'hapus_penjualan': $id = $_GET['id_penjualan']; mysqli_query($koneksi, "DELETE FROM tb_penjualan WHERE id_penjualan='$id'");
                include "menu/data_penjualan.php";
              break;
              ...
              case 'hapus_distributor': $id = $_GET['id_distributor']; mysqli_query($koneksi, "DELETE FROM tb_distributor WHERE id_distributor='$id'");
                include "menu/data_distributor.php";
              break;
